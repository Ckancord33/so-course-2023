...
docker stop contenedor1 contenedor2 contenedor3 2>/dev/null
docker rm contenedor1 contenedor2 contenedor3 2>/dev/null
...
docker run -d --name contenedor3 --network synchrontainer-network -p 5002:5000 -e CONTAINERS=$CONTAINERS -e MY_CONTAINER=contenedor3 synchrontainer
